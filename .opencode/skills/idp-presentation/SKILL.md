...
- The interim deck `presentations/presentation/` was DELETED in the handover cleanup
  (2026-09-22); only the final deck ships. Recover it from git history if needed.
